jQuery(function () {
    ...
    $(".menu-burger").on("click", function () {
        $('.menu-burger, .header__down-slide').toggleClass('active');
    });

    //Мобильное меню
    $("#MENS-mobile").on("click", function () {
        $('.header__mens-list').slideToggle();
    });
    $("#WOOMENS-mobile").on("click", function () {
        $('.header__womens-list').slideToggle();
    });

    //Скрытое меню
    $(".Mens").on("click", function () {
        //$(".header__men-menu").fadeIn(200);
        $(".header__men-menu").toggle(200);
        //$(".header__women-menu").fadeOut(200);

    });
    $(document).mouseup(function (e) {
        var container = $(".header__men-menu");
    ...
    $(".Womens").on("click", function () {
        $(".header__women-menu").toggle(200);
    });
    $(document).mouseup(function (e) {
        var container = $(".header__women-menu");
        if (container.has(e.target).length === 0) {
            container.hide(200);
        }
    });
